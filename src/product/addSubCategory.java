    ...
    private  String addSubCategory (String SubCategoryName, String categoryName){
        ...
        if (SubCategoryName.equals("")){
            ...
            try {
                ...
                String sqlInsertCompany ="INSERT INTO  `bestchoice`.`sub-category` (`subcategory_id` ,`sub-category_name` ,`category_name`)VALUES (NULL ,  '"+SubCategoryName+"',  '"+categoryName+"');"; 
               // "INSERT INTO  `bestchoice`.`product-company` (`company-id` ,`company-name`)VALUES (NULL ,  '"+companyName+"');";                
                //String sqlInsertProduct = "INSERT INTO  `bestchoice`.`category` (`category_id` ,`category_name`)VALUES (NULL ,  '"+companyName+"'); ";
